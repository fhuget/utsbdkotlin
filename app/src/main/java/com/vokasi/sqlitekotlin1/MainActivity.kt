package com.vokasi.sqlitekotlin1
...
import com.vokasi.sqlitekotlin1.helper.MyAdapter
import com.vokasi.sqlitekotlin1.model.DatabaseHandler
...
class MainActivity : AppCompatActivity() {
    ...
    fun saveRecord(view: View){
        ...
        if(id.trim()!="" && name.trim()!="" && email.trim()!="" && nohp.trim()!=""){
            ...
            if(status > -1){
                Toast.makeText(applicationContext,"Data Pegawai Tersimpan",Toast.LENGTH_LONG).show()
                u_id.text.clear()
                u_name.text.clear()
                u_email.text.clear()
                u_nohp.text.clear()
    ...
    fun deleteRecord(view: View){
        ...
        dialogBuilder.setPositiveButton("Delete", DialogInterface.OnClickListener { _, _ ->
            ...
            if(deleteId.trim()!=""){
                ...
                if(status > -1){
                    Toast.makeText(applicationContext,"Data Pegawai dihapus",Toast.LENGTH_LONG).show()
                }
            }else{
                Toast.makeText(applicationContext,"Isi IDnya terlebih dahulu",Toast.LENGTH_LONG).show()
            }
